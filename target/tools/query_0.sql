...
select case when (select count(*) 
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 21 and 40) > 73740
            then (select avg(ss_ext_discount_amt)
                  from store_sales
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 41 and 60) > 49185
            then (select avg(ss_ext_discount_amt)
                  from store_sales
...
with year_total as (
 ...
 select * from ( select  t_s_secyear.customer_email_address
...
where ss_item_sk = i_item_sk and
      ...
      d_year in (1998) and
        ((i_category in ('Books','Home','Music') and
          i_class in ('arts','flatware','pop')
         )
      or (i_category in ('Sports','Women','Shoes') and
          i_class in ('football','swimwear','athletic') 
        ))
...
select * from (select  distinct(i_product_name)
 ...
 where i_manufact_id between 735 and 735+40 
   and (select count(*) as item_cnt
        ...
        (i_category = 'Men' and
        (i_color = 'snow' or i_color = 'smoke') and
       ...
       (i_manufact = i1.i_manufact and
        ...
        (i_category = 'Women' and
        (i_color = 'lime' or i_color = 'peach') and
 ...
 from store_sales
     ...
     (SELECT substr(ca_zip,1,5) ca_zip
      ...
      WHERE substr(ca_zip,1,5) IN (
                          '55509','91908','67804','28717','44425','69823',
                          '36301','13741','15106','35227','98548',
                          '71285','49158','13590','21670','42180',
                          '90928','53275','52255','41379','60367',
                          '34998','51412','43107','32499','11152',
                          '12168','92177','92362','35853','13402',
                          '95834','29925','71958','81310','75321',
                          '11221','70282','19899','54776','27245',
                          '26258','64464','26483','24879','65653',
                          '23789','67076','22828','19179','66461',
                          '30917','76926','10396','21574','58481',
                          '36770','82770','22313','14115','11472',
                          '76372','59239','31535','86341','10204',
                          '33608','29126','26320','72596','29026',
                          '81239','11693','15353','93325','32149',
                          '50283','14686','82357','12926','45976',
                          '33571','37657','26261','14868','61636',
                          '76909','98031','19188','69450','68096',
                          '65918','44188','54364','20811','53181',
                          '56908','89803','64029','55582','40897',
                          '20871','41957','84877','40732','49652',
                          '14071','68980','59584','99359','13370',
                          '12630','32826','14655','26722','13460',
                          '52171','55628','36010','54876','70505',
                          '56572','17368','36235','19469','39141',
                          '56095','10015','76330','31260','75426',
                          '30907','47812','52956','41334','74430',
                          '44045','54815','44155','42380','16904',
                          '27436','50226','73422','99628','94750',
                          '60728','26988','85403','91053','17695',
                          '85420','27460','76619','90536','37284',
                          '12228','12651','41121','53708','43389',
                          '79224','61821','64197','78446','53548',
                          '74656','34320','70700','64541','64828',
                          '26474','51725','99954','85049','53056',
                          '84109','38329','23274','30330','48436',
                          '21599','37462','49922','31109','37831',
                          '15842','79477','39605','15517','14946',
                          '78043','91452','21341','27909','28910',
                          '43030','22405','21266','36757','57454',
                          '48500','28456','63604','15077','16929',
                          '64380','18933','32240','48249','17910',
                          '82192','90040','27482','39712','57700',
                          '15810','85792','50002','41326','67125',
                          '56941','13922','40140','48245','34370',
                          '80444','77878','73277','60716','15868',
                          '90159','47981','66559','30518','11236',
                          '36677','50020','90447','78823','96947',
                          '29516','43306','61244','45154','20564',
                          '74503','42231','18867','32539','65764',
                          '92315','76844','63441','85154','75344',
                          '15568','40185','56358','99642','15224',
                          '78429','77095','41642','37084','99877',
                          '54370','36204','88015','15945','71523',
                          '37969','63844','33938','24112','70185',
                          '47070','98027','86191','18743','58608',
                          '36601','63171','59954','98422','87951',
                          '12993','12859','84839','29072','93148',
                          '62553','74859','17873','74893','21584',
                          '65684','23480','52253','83053','13100',
                          '20584','30104','43195','66741','56393',
                          '19080','83269','12485','47367','56383',
                          '55823','88488','12304','26372','13687',
                          '77560','77744','98588','35401','11133',
                          '75289','81400','43784','39386','84169',
                          '32564','33143','29487','70603','52548',
                          '44599','32929','60963','35310','38759',
                          '45145','20316','16096','80985','75531',
                          '33362','61439','29999','39387','58308',
                          '11180','70988','30652','87335','24885',
                          '78634','83371','20606','40999','21342',
                          '18362','71064','51875','65865','98550',
                          '22939','63744','71132','79410','85074',
                          '67687','41988','21986','49467','84591',
                          '52882','17363','11817','47723','14775',
                          '81126','71157','31317','83047','26464',
                          '11331','11015','56123','91625','47867',
                          '42577','44048','50834','12434','81540',
                          '66346','86009','86379','51626','88725',
                          '98877','69511','36582','71971'))
     intersect
     (select ca_zip
...
select * from (select  i_item_id
 ...
 and i_manufact_id in (31,795,327,924)
 and inv_quantity_on_hand between 100 and 500
 and ss_item_sk = i_item_sk
 group by i_item_id,i_item_desc,i_current_price
 order by i_item_id
...
select * from (select  c_customer_id as customer_id
 ...
 where ca_city	        =  'Pleasant Grove'
   and c_current_addr_sk = ca_address_sk
   and ib_lower_bound   >=  214
   and ib_upper_bound   <=  214 + 50000
...
with ss as (
 ...
 where i_item_id in (select
     i_item_id
from item
where i_color in ('steel','coral','royal'))
 and     ss_item_sk              = i_item_sk
 and     ss_sold_date_sk         = d_date_sk
 and     d_year                  = 2001
 and     d_moy                   = 7
...
select * from (select  i_item_id,
 ...
 where cs_sold_date_sk = d_date_sk and
       ...
       c_birth_month in (12,8,11,4,10,5) and
       d_year = 2002 and
       ca_state in ('AR','AL','MA'
                   ,'MS','CO','UT','NY')
...
select * from (  select  t_s_secyear.customer_birth_country
 from year_total t_s_firstyear
     ,year_total t_s_secyear
...
with sr_items as
 ...
 and   d_date    in 
	...
	where d_week_seq in 
		(select d_week_seq
		from date_dim
	  where d_date in ('2001-05-04','2001-10-03','2001-11-06')))
